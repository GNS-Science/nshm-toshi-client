...
``` console
$ curl -OJL https://github.com/gns-science/nshm-toshi-client/tarball/main
```
...
```
  ...
  [Github repo]: https://github.com/gns-science/nshm-toshi-client
  [tarball]: https://github.com/gns-science/nshm-toshi-client/tarball/main
